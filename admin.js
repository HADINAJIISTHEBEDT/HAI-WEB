(function () {
  ...
  var UI = {
    ...
    ar: {
      adminBrand: "HAI SOFTWARE INTELLIGENCE - لوحة الإدارة",
      ...
      primaryColor: "اللون الرئيسي (hex)",
      ...
      statusSignInPrompt: "يرجى تسجيل الدخول أولاً لتعديل محتوى الموقع.",
      ...
      statusChooseImage: "يرجى اختيار صورة أولاً.",
      statusUploadingImage: "جاري رفع الصورة...",
      statusUploadDone: "اكتمل الرفع. يرجى الضغط على حفظ التغييرات.",
      statusUploadFailed: "فشل رفع الصورة: {error}",
      statusEnterCredentials: "أدخل البريد الإلكتروني وكلمة المرور.",
      statusLoginFailed: "فشل تسجيل الدخول: {error}",
      statusSignedOut: "تم تسجيل الخروج.",
      statusSignOutFailed: "فشل تسجيل الخروج: {error}",
      statusResetDone: "تمت الاستعادة. اضغط حفظ التغييرات لنشر القيم الافتراضية.",
      statusPreviewRefreshed: "تم تحديث المعاينة.",
      statusExported: "تم تصدير ملف JSON.",
      statusImported: "تم استيراد JSON. اضغط حفظ التغييرات للنشر إلى Firebase.",
      statusImportFailed: "فشل الاستيراد: ملف JSON غير صالح.",
      statusFirebaseNotConfigured: "لم يتم إعداد Firebase بعد. استخدم نموذج إعدادات Firebase أعلاه ثم احفظ.",
      confirmReset: "هل تريد استعادة كل المحتوى إلى القيم الافتراضية؟",
      ...
      firebaseConfigTitle: "إعدادات Firebase",
      firebaseConfigHint: "الصق إعدادات تطبيق الويب مرة واحدة، ثم احفظ وأعد التحميل.",
      cfgApiKey: "API Key",
      cfgAuthDomain: "Auth Domain",
      cfgProjectId: "Project ID",
      cfgStorageBucket: "Storage Bucket",
      cfgMessagingSenderId: "Messaging Sender ID",
      cfgAppId: "App ID",
      saveFirebaseConfig: "حفظ إعدادات Firebase",
      clearFirebaseConfig: "مسح الإعدادات",
      statusConfigSaved: "تم حفظ الإعدادات. جاري إعادة التحميل...",
      statusConfigCleared: "تم مسح الإعدادات. جاري إعادة التحميل...",
      statusConfigInvalid: "يرجى تعبئة جميع حقول إعدادات Firebase.",
      statusConfigSaveFailed: "تعذر حفظ الإعدادات: {error}"
    }
  };
  ...
  function applyAdminLanguage() {
    document.documentElement.lang = adminUiLanguage === "ar" ? "ar" : "en";
